...
Ensure you have installed the [extended version of Hugo](https://github.com/gohugoio/hugo/releases) and [Asciidoctor](https://asciidoctor.org/docs/install-toolchain/). See installation steps from [Hugo's official docs](https://gohugo.io/getting-started/installing/) and [Asciidoctor](https://asciidoctor.org/docs/install-toolchain/)
